...
int main(int argc, char ** argv) {
    ...
    llama_decode(ctx_tgt, llama_batch_get_one( inp.data(), n_input - 1, 0,           0), 0);
    llama_decode(ctx_tgt, llama_batch_get_one(&inp.back(),           1, n_input - 1, 0), 0);
    llama_decode(ctx_dft, llama_batch_get_one( inp.data(), n_input,     0,           0), 0);
    ...
    while (true) {
...

        {
            ...
            llama_decode(ctx_dft, batch_dft, 0);
        ...
        // evaluate the target model on the drafted tokens
        {
            ...
            llama_decode(ctx_tgt, batch_tgt, 0);
            ++n_past_tgt;
        }
